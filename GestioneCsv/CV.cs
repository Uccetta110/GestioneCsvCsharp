...
namespace GestioneCsv
{
    internal class CV
    {
        ...
        protected string PaeseResidenza { set; get; }
        protected string Email { set; get; }
        protected string Esperienze { set; get; }

        protected int Cell { set; get; }

        public CV(string cognome, string nome, string classe, string indirizzo, string paese, string email, int cell, string esperienze)
        {
            Cognome = cognome;
            Nome = nome;
            Classe = classe;
            Indirizzo = indirizzo;
            PaeseResidenza = paese;
            Email = email;
            Cell = cell;
